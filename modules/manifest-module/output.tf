...
output "manifest_contents" {
  ...
  value = "Manifest file originally created by Terraform Stacks Tutorial at ${time_static.static_timestamp.rfc3339}:  manifest.txt plus ${length(var.additional_files)} additional files"
}